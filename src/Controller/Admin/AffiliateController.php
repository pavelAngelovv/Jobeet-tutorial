...
class AffiliateController extends AbstractController
{
    ...
    {   /** @var \App\Repository\AffiliateRepository $affiliateRepository */
        $affiliateRepository = $em->getRepository(Affiliate::class);
        $affiliates = $paginator->paginate(
            $affiliateRepository->createQueryBuilder('a'),
            $page,
